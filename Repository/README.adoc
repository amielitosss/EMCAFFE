...
// /!\ A MODIFIER !!!
:baseURL: https://github.com/IUT-Blagnac/sae-5-a-01-2024-2025-emcaffe-jaune
...
- Version courante : https://github.com/IUT-Blagnac/sae-5-a-01-2024-2025-emcaffe-jaune/releases/tag/3.0[v3.0]
...
Pour consulter le document technique qui détaille l'installation, les étapes de démarrage pour le développement du projet ainsi que la structure du projet, vous pouvez le lire https://github.com/IUT-Blagnac/sae-5-a-01-2024-2025-emcaffe-jaune/blob/read-me/docs/doc-tech.md[ici].
